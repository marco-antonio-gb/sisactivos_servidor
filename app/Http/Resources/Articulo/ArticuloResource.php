...
class ArticuloResource extends JsonResource {
	...
	public function toArray($request) {
		return [
			...
			'creado'           => Carbon::parse($this->created_at, 'America/La_Paz')->translatedFormat('j \d\e F \d\e\l Y'),
			'actualizado'      => Carbon::parse($this->updated_at, 'America/La_Paz')->translatedFormat('l, j \d\e F \d\e\l Y, H:i:s'),
			'fecha_registro'   => Carbon::parse($this->fecha_registro, 'America/La_Paz')->translatedFormat('l, j \d\e F \d\e\l Y, H:i:s'),
